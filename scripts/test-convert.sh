...
curl -s -X POST "${BASE_URL}/convert" \
  ...
  -d '{
    "templateVars": {
      ...
      "nombredocente": "Arturo Barrera",
      "ie": "Institución Educativa Ejemplo",
      "nivel": "Secundaria",
      "grado": "Quinto",
      "area": "Matemática",
      "seccion": "A",
      ...
      "Criterios": "Explica de forma clara el proceso de resolución.",
      "Evaluacion": "",
      "estandar": "",
      ...
      "valores": "",
      "actitudes": "",
      "tiempoinicio": "20 minutos",
      "tiempodesarollo": "50 minutos",
      "tiempocierre": "10 minutos",
